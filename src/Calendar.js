    ...
    return (
      ...
      >
        ...
        <div className="left-column-content" style={{ padding: '10px' }}>
          ...
          <span style={{fontFamily: 'Segoe UI', fontSize: '12px', fontWeight: 400, lineHeight: '16px', letterSpacing: '0px', textAlign: 'left',display:'inline-flex'}}>Recommended hours are calculated considering outlook and assignment information</span>
        </div>
      </div>
          <div class="right-column" style={{width: '87.5%', height: '473px'}}><View
          {...props}
          events={events}
